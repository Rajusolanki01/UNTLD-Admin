...
const BlogCategoryList = () => {
  ...
  const handleModalOk = () => {
    dispatch(
      updateTheBlogCategoryTitle({
        blogCategoryId: selectedBlogCategoryId,
  ...
  return (
    <div>
                ...
                <div className="d-flex gap-2">
                  <div>
                    <button
                      className="editBtn"
                      onClick={() => {
                        setSelectedBlogCategoryId(record._id);
      ...
      >
        <p>Please Add New Blog Category Title:</p>
        <CustomInput
          style={{ width: 100 }}
          type="text"
          label="Enter the Blog Category Name"
